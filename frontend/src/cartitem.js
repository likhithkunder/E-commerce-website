...
function Item(props) {
  ...
  const removeitem=async()=>{
    ...
    return ( 
        ...
        <div class="p-4 w-[75%] rounded-lg shadow-xl hover:scale-[1.1] bg-grey">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left w-full">
          ...
          <div class="w-full sm:pl-8">
           ...
           {loc.pathname.startsWith('/order')?null: <button onClick={removeitem} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Remove</button>}
        </div>
          </div>
        </div>
      </div>

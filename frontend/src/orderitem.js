...
function Singleorder(props) {
    ...
    return ( 
        ...
        {item ?<div class="grid grid-flow-row gap-4  items-center  " onClick={test}>{props.data.products.map((t) => (
                ...
                ))}</div>:<button onClick={test} class="text-white bg-blue-700 hover:bg-blue-800  focus:ring-blue-300 font-medium rounded-lg p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700">Show items</button>}

      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          ...
          <span class="mr-3">Quantity</span>
            <div class="relative">
            <input type="number" onChange={changeval} value={quan} class="rounded w-20 border appearance-none border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 text-base p-2"/>
        ...
        <div class="flex">
          ...
          <button onClick={addcart} class="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Add to cart</button>
        </div>
      </div>
    </div>
  </div>
